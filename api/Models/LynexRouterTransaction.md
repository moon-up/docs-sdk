...
| **maxPriorityFeePerGas** | **String** | The maximum priority fee per gas unit for the transaction (optional). | [optional] [default to null] |
| **maxFeePerGas** | **String** | The maximum fee per gas unit for the transaction (optional). | [optional] [default to null] |
