# VoteWithOptimalDistribution_request_2
## Properties

| Name | Type | Description | Notes |
|------------ | ------------- | ------------- | -------------|
| **to** | **String** | The recipient address of the transaction (optional). | [optional] [default to null] |
| **data** | **String** | The data payload of the transaction (optional). | [optional] [default to null] |
| **value** | **String** | The value to be sent with the transaction, in wei (optional). | [optional] [default to null] |
| **gasLimit** | **String** | The gas limit for the transaction (optional). | [optional] [default to null] |
| **nonce** | **String** | The nonce of the transaction (optional). | [optional] [default to null] |
| **simulate** | **Boolean** | Indicates whether to simulate the transaction (optional). | [optional] [default to null] |
| **gas** | **String** | The gas limit for the transaction (optional). | [optional] [default to null] |
...
| **dryrun** | **Boolean** | Indicates whether to perform a dry run of the transaction (optional). | [optional] [default to null] |
| **input** | **String** | The input data. | [optional] [default to null] |
| **EOA** | **Boolean** | Indicates whether the transaction is from an externally owned account (optional). | [optional] [default to null] |
| **contract\_address** | **String** | The contract address involved in the transaction (optional). | [optional] [default to null] |
| **token\_id** | **String** | The token ID involved in the transaction (optional). | [optional] [default to null] |
...
| **broadcast** | **Boolean** | Indicates whether to broadcast the transaction (optional). | [optional] [default to null] |
| **alwaysIncrementNonce** | **Boolean** | Indicates whether to always increment the nonce (optional). | [optional] [default to null] |
| **asset** | **String** | The asset involved in the transaction. | [optional] [default to null] |
| **amount** | **String** | The amount to be transferred (optional). | [optional] [default to null] |
...
| **amounts** | **List** | The amounts involved in the transaction. | [optional] [default to null] |
