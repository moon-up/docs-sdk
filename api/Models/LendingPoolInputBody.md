...
|------------ | ------------- | ------------- | -------------|
| **to** | **String** | The address to which the operation is directed. | [optional] [default to null] |
| **data** | **String** | Additional data for the operation. | [optional] [default to null] |
| **value** | **String** | The value involved in the operation. | [optional] [default to null] |
...
| **simulate** | **Boolean** | Flag indicating if the operation should be simulated. | [optional] [default to null] |
...
| **dryrun** | **Boolean** | Flag indicating if the operation is a dry run. | [optional] [default to null] |
| **input** | **String** | The input data. | [optional] [default to null] |
| **EOA** | **Boolean** | Flag indicating if the operation is performed by an Externally Owned Account. | [optional] [default to null] |
| **contract\_address** | **String** | The contract address involved in the operation. | [optional] [default to null] |
...
| **broadcast** | **Boolean** | Flag indicating if the transaction should be broadcasted. | [optional] [default to null] |
| **alwaysIncrementNonce** | **Boolean** | Flag indicating if the nonce should always be incremented. | [optional] [default to null] |
| **asset** | **String** | The asset involved in the operation. | [optional] [default to null] |
| **amount** | **String** | The amount involved in the operation. | [optional] [default to null] |
...
| **onBehalfOf** | **String** | The address on behalf of which the operation is performed. | [optional] [default to null] |
| **receiverAddress** | **String** | The address of the receiver. | [optional] [default to null] |
| **assets** | **List** | Array of assets involved in the operation. | [optional] [default to null] |
| **amounts** | **List** | Array of amounts involved in the operation. | [optional] [default to null] |
| **modes** | **List** | Array of modes involved in the operation. | [optional] [default to null] |
| **params** | **String** | Additional parameters for the operation. | [optional] [default to null] |
| **rateMode** | **Double** | The rate mode for the operation. | [optional] [default to null] |
| **useAsCollateral** | **Boolean** | Flag indicating if the asset should be used as collateral. | [optional] [default to null] |
...
| **user** | **String** | The user involved in the operation. | [optional] [default to null] |
| **debtToCover** | **String** | The debt to cover. | [optional] [default to null] |
| **receiveAToken** | **Boolean** | Flag indicating if AToken should be received. | [optional] [default to null] |
