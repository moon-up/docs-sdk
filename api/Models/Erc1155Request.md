...
| **token\_ids** | **String** | Optional. A comma-separated list of token IDs. | [optional] [default to null] |
| **approved** | **Boolean** | Optional. Indicates whether the tokens are approved. | [optional] [default to null] |
