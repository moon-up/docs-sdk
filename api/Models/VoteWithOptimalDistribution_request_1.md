# VoteWithOptimalDistribution_request_1
## Properties
...
| **value** | **String** | The value associated with the transaction. | [optional] [default to null] |
...
| **pool** | **String** | The pool involved in the transaction. | [optional] [default to null] |
| **gauge** | **String** | The gauge involved in the transaction. | [optional] [default to null] |
| **weights** | **List** | The weights for the transaction. | [optional] [default to null] |
| **pool\_vote** | **List** | The pool votes for the transaction. | [optional] [default to null] |
| **bribes** | **List** | The bribes for the transaction. | [optional] [default to null] |
| **tokens** | [**List**](array.md) | The tokens involved in the transaction. | [optional] [default to null] |
| **fees** | **List** | The fees for the transaction. | [optional] [default to null] |
| **gauges** | **List** | The gauges involved in the transaction. | [optional] [default to null] |
