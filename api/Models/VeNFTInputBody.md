...
| **data** | **String** | Additional data for the transaction. | [optional] [default to null] |
| **value** | **String** | The value of the transaction. | [optional] [default to null] |
...
| **simulate** | **Boolean** | Indicates whether to simulate the transaction. | [optional] [default to null] |
...
| **dryrun** | **Boolean** | Indicates whether to perform a dry run of the transaction. | [optional] [default to null] |
| **input** | **String** | The input data. | [optional] [default to null] |
| **EOA** | **Boolean** | Indicates whether the transaction is from an externally owned account. | [optional] [default to null] |
| **contract\_address** | **String** | The contract address involved in the transaction. | [optional] [default to null] |
| **token\_id** | **String** | The token ID involved in the transaction. | [optional] [default to null] |
| **token\_ids** | **String** | The token IDs. | [optional] [default to null] |
| **approved** | **Boolean** | Indicates whether the transaction is approved. | [optional] [default to null] |
| **broadcast** | **Boolean** | Indicates whether to broadcast the transaction. | [optional] [default to null] |
| **alwaysIncrementNonce** | **Boolean** | Indicates whether to always increment the nonce. | [optional] [default to null] |
| **asset** | **String** | The asset involved in the transaction. | [optional] [default to null] |
| **amount** | **String** | The amount to be transferred. | [optional] [default to null] |
